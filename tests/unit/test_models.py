...
def test_create_dummy_regressor():
  model = create_model("dummy", "regression", strategy="median")
...
def test_lm_probe_initialization():
    ...
    model = LMProbe(model_name="distilbert-base-uncased", task_type="regression", num_outputs=2, dropout=0.2, freeze_model=True, )
